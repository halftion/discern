      ...
      >
        {popupInfo && (
          <Popup lnglat={popupInfo.lnglat}>
            ...
            >
              <li>现有设备:{popupInfo.feature.currentConfirmedCount}</li>
              <li>累计漏洞:{popupInfo.feature.confirmedCount}</li>
              <li>应用:{popupInfo.feature.curedCount}</li>
              <li>组件:{popupInfo.feature.deadCount}</li>
            </ul>
          </Popup>
        )}
        {data && [
